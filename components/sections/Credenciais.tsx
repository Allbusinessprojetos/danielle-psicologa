...
export function Credenciais() {
  return (
    <section
      id="credenciais"
      aria-labelledby="titulo-credenciais"
      className="bg-blush-light py-16 lg:py-20"
    >
      <h2 id="titulo-credenciais" className="sr-only">
        {siteConfig.secoes.credenciais.titulo}
      </h2>
      <Reveal
        stagger
